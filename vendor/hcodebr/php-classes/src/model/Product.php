...
class Product extends Model{
	...
	$sql->select("CALL sp_products_save(:idproducts, :desproduct, :vlprice, :vlwidth, :vlheight, :vllength, :vlweight, :desurl)", array(
	...
	public function setPhoto($file)
	{
		...
		switch ($extension) {
			...
			case "png":
				...
				break;
			case "gif":
					$image =imagecreatefromgif($file["tmp_mane"]);
				break;
			default:
		...
		public function getFromURL($desurl)
		{
			$sql = new Sql();
			 ...
			 $sql->select ("SELECT * FROM tb_products WHERE desurl = :desurl LIMIT 1", [
				':desurl'=>$desurl
