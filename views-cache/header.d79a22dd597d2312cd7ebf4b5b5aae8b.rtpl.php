...
<!--
   LOJA MASTER STORE by Diogotigrejw@gmail.com.br
-->
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
   ...
   <!-- Ajuste HTML5 e Respond.js para suporte do IE8 a elementos HTML5 e consultas de mídia ->
    <! - AVISO: O Respond.js não funciona se você visualizar a página através do arquivo: // ->
    <! - [se lt IE 9]>
...
>                </div>
    ...
    </div> <!-- Área de marca do site final -->
